      ...
      <div className="w-full min-h-screen footer-bg">
        <div className="flex flex-col items-center gap-12 px-4 text-white md:px-8 lg:px-12 xl:px-24 2xl:px-36 3xl:px-48">
          <img
            src={Pixpel}
            alt="footer_pixpel"
            className="sm:w-full lg:w-3/4 xl:w-3/5 2xl:w-1/2"
          />
          <div className="flex items-center justify-center w-full gap-2 lg:gap-8 md:gap-4">
            <a
              href="https://www.facebook.com/pages/category/Financial-service/Pixpel-100577316004386/"
              rel="noreferrer"
              target="_blank"
            >
              <img
                src={FaceBook}
                alt="book"
                className="w-5 lg:w-9 md:w-7 sm:w-6"
              />
            </a>
            <a
              href="https://twitter.com/PixpelPlatform?t=aBKBqFiERPwY7mZW2ZtAPg&s=09/"
              rel="noreferrer"
              target="_blank"
            >
              <img
            ...
            <a
              href="https://discord.gg/JUPxf3HFrN/"
              rel="noreferrer"
              target="_blank"
            >
              <img
